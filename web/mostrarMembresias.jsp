    ...
    <body>
        ...
        <div class="main-content">
            <div class="title d-flex  justify-content-between align-items-center">
                ...
                <button  class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="fas fa-plus-circle" ></i>Nueva Membresia</button>
            </div>
            <div class="main">
                                ...
                                <div class="modal-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="txtNom">Id Membresia</label>
                                            <input type="text" class="form-control" readonly="true" name="txtIdMembresia" id="txtNom" value="${membresias.idMembresia}">
                                        </div>
                                    </div>
                                    <div class="form-group">

                                            <label for="txtFecha">Fecha Registro</label>
                                            <input type="date" name="txtFechaRegistro" id="txtFecha" class="form-control" value="${membresias.fechaRegistro}"><br>
                                        </div>
                                        <div class="form-group">

                                            <label for="txtFecha">Fecha Vencimiento</label>
                                            <input type="date" name="txtFechaVencimiento" id="txtFecha" class="form-control" value="${membresias.fechaVencimiento}"><br>
                                        </div>
                                        <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="txtNom">Monto</label>
                                            <input type="text" class="form-control" name="txtMonto" id="txtNom" value="${membresias.monto}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="txtExpediente" >
                                            ...
                                            <c:forEach var="item" items="${pacientes}">
                                                <option value="${item.expediente}">${item.expediente}</option>
                                            </c:forEach> 
                                        </select>
                ...
                <div class="tbPac">
                    <div class="busqueda" style="width: 50%; text-align: right">
                        <form action="${pageContext.servletContext.contextPath}/SMembresias" method="get">
                            <input type="txtBusquedaMembresia" name="txtBusquedaMembresia" id="txtBusquedaProducto" value="${valor}" />
                    ...
                    <script>
                        window.onload = function () {
                            document.getElementById("txtBusquedaMembresia").focus();
                        };
                    </script> 
