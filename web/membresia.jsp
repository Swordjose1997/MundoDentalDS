...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            <div class="title d-flex  justify-content-sm-between align-items-center">
                <h5>
                    REGISTRO DE MEMBRESIAS
                </h5>
                <a class="btn btn-primary" href="Membresias?accion=mostrar"><i class="fas fa-eye"></i>  Mostrar Membresias</a>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="main col-md-4">
                        ...
                        <button class="btn btn-primary" data-toggle="modal" data-target="#modalProducto" data-whatever="@mdo" ><i class="fas fa-plus-circle" ></i> Agregar Beneficiarios</button><br>
